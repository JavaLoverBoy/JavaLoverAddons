...
public class RenderUtils {
    ...
    public static void drawPointESP(Vec3d vec3d, Color color, float partialTicks) {
        ...
        final double x = vec3d.x - renderManager.viewerPosX;
        final double y = vec3d.y - renderManager.viewerPosY;
        final double z = vec3d.z - renderManager.viewerPosZ;
    ...
    public static void drawFaceESP(BlockPos blockPos, EnumFacing enumFacing, Color color, float partialTicks) {
        final RenderManager renderManager = mc.getRenderManager();
        ...
        switch (enumFacing) {
            case UP:
                drawTopFace(axisAlignedBB);
                break;
            case DOWN:
                drawBottomFace(axisAlignedBB);
                break;
            case NORTH:
                drawNorthFace(axisAlignedBB);
                break;
            case SOUTH:
                drawSouthFace(axisAlignedBB);
                break;
            case EAST:
                drawEastFace(axisAlignedBB);
                break;
            case WEST:
                drawWestFace(axisAlignedBB);
                break;
        }
    ...
    public static void drawTopFace(AxisAlignedBB bb) {
        glBegin(GL_LINES);
    ...
    public static void drawBottomFace(AxisAlignedBB bb) {
        glBegin(GL_LINES);
    ...
    public static void drawNorthFace(AxisAlignedBB bb) {
        glBegin(GL_LINES);
        glVertex3d(bb.minX, bb.minY, bb.minZ);
        glVertex3d(bb.maxX, bb.minY, bb.minZ);
    ...
    public static void drawSouthFace(AxisAlignedBB bb) {
        glBegin(GL_LINES);
        glVertex3d(bb.maxX, bb.minY, bb.maxZ);
        glVertex3d(bb.minX, bb.minY, bb.maxZ);
    ...
    public static void drawEastFace(AxisAlignedBB bb) {
        glBegin(GL_LINES);
        glVertex3d(bb.maxX, bb.minY, bb.minZ);
        glVertex3d(bb.maxX, bb.minY, bb.maxZ);
    ...
    public static void drawWestFace(AxisAlignedBB bb) {
        glBegin(GL_LINES);
        glVertex3d(bb.minX, bb.minY, bb.maxZ);
        glVertex3d(bb.minX, bb.minY, bb.minZ);
